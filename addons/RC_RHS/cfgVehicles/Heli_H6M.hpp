...
class RC_AU_MELB_AH6M_O: RC_AI_MELB_AH6M
{
...
class RC_AI_MELB_AH6M_I: RC_AI_MELB_AH6M
{
...
class RC_MELB_OM_AH6M_DAP_UV: RC_MELB_AH6M_Base
{
	...
	displayName="RC AH-6M DAP - Little Bird";
};
...
class RC_MELB_OM_MH6M_DAP_UV: RC_MELB_MH6M_DAP_Base
{
	...
	displayName="RC MH-6M DAP - Little Bird";
};
...
class RC_MELB_OM_MH6M_UV: RC_MELB_MH6M_Base
{
	...
	displayName="RC MH-6M - Little Bird";
};
