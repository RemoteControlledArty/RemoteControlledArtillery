class B_P1Sun_TI_F;
class B_Interceptor_MP_Base: B_P1Sun_TI_F
{
	scope=0;
	scopeCurator=0;
	class EventHandlers;
...
class B_Interceptor_MP: B_Interceptor_MP_Base
{
	...
	//bodyFrictionCoef=0.012;	//0.012, lowering increases speed but reduces control
	//liftForceCoef=4;	//4
	cyclicForwardForceCoef=2;		//6,  vertical steering sensitivity, 0.8 is less oversensitive
	cyclicAsideForceCoef=12;		//4, horizontal seering sensitivity
