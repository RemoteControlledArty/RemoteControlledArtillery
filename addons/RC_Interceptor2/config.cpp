...
class CfgAmmo
{
	#include "\RC_Interceptor2\cfgAmmoMagazinesWeapons\Ammo.hpp"
};
class CfgMagazines
{
	#include "\RC_Interceptor2\cfgAmmoMagazinesWeapons\Magazines.hpp"
};
class Mode_SemiAuto;
class CfgWeapons
{
	#include "\RC_Interceptor2\cfgAmmoMagazinesWeapons\Weapons.hpp"
};
class CfgVehicles
{
	#include "\RC_Interceptor2\cfgVehicles\Interceptor.hpp"
};