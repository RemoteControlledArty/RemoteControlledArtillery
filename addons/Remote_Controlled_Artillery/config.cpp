class CfgPatches
{
	class RC_Artillery
	{
		...
		units[]=
		{
			...
			"RC_OMH_BenchPod_blk_I",

			"RC_OMH_TransportPod_blk",
			"RC_OMH_TransportPod_blk_O",
			"RC_OMH_TransportPod_blk_I",
			...
			*/
			...
			"RC_Mule_UGV_ReArmPairFuel_A_O",
			"RC_Mule_UGV_ReArmPairFuel_A_I",
			"RC_Mule_UGV_ReArmPairFuel_WD",
			"RC_Mule_UGV_ReArmPairFuel_WD_O",
			"RC_Mule_UGV_ReArmPairFuel_WD_I",
			
			"RC_ReSupplyPallet",
			"RC_Mule_UGV_ReSupply_A",
			"RC_Mule_UGV_ReSupply_A_O",
			"RC_Mule_UGV_ReSupply_A_I",
			"RC_Mule_UGV_ReSupply_WD",
			"RC_Mule_UGV_ReSupply_WD_O",
			"RC_Mule_UGV_ReSupply_WD_I",
...
class CfgFunctions
{
	class RC
	{
		...
		class RC_FPV
		{
			...
			class RC_FPV_Request_define {preInit=1;};
...
class CfgEditorSubcategories
{
	...
	class RC_Heli_V2_subcat {displayname="Helis - V2 : .50";};
	class RC_Heli_V3_subcat {displayname="Helis - V3 : AC & Rockets LowCapacity";};
	class RC_Heli_V4_subcat {displayname="Helis - V4 : AC & Rockets";};
	class RC_Heli_V5_subcat {displayname="Helis - V5 : AC & Missiles";};
	class RC_Heli_V6_subcat {displayname="Helis - V6 : Missiles & Missiles";};
