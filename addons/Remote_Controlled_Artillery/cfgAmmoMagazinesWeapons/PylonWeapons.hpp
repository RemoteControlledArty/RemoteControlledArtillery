...
class RC_Twin_Cannon_20mm_gunpod_slow: RC_Twin_Cannon_20mm_gunpod_slow_core
{
	allowTabLock=1;
	canLock=2;
	weaponLockDelay=0;
...
class RC_Twin_Cannon_25mm_gunpod_slow: RC_Twin_Cannon_20mm_gunpod_slow
{
	displayName="25mm AC";
...
class RC_Twin_Cannon_30mm_gunpod_slow: RC_Twin_Cannon_20mm_gunpod_slow
{
	displayName="30mm AC";
