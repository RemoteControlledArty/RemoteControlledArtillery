...
class RC_PylonM_12Rnd_70mm_Hydra_HE: PylonRack_12Rnd_missiles
{
	...
	author="Ascent";
	displayName="[12x Hydra HE]";
	displayNameShort="Hydra HE";
	descriptionShort="12x Hydra HE";
...
{
	displayName="[12x Hydra MP]";
	displayNameShort="Hydra MP";
	descriptionShort="12x Hydra MP";
	ammo="RC_Hydra_MP";
};
...
{
	author="Ascent";
	displayName="[19x Hydra HE]";
	displayNameShort="Hydra HE";
	descriptionShort="19x Hydra HE";
...
{
	displayName="[19x Hydra MP]";
	displayNameShort="Hydra MP";
	descriptionShort="19x Hydra MP";
	ammo="RC_Hydra_MP";
};