...
class RscOptics_TGP_Camera_01;
class RC_RscOptics_TGP_Camera_01_Fetch: RscOptics_TGP_Camera_01
{
    class CA_IGUI_elements_group;
    class Controls;
};
class RC_RscOptics_TGP_Camera_01: RC_RscOptics_TGP_Camera_01_Fetch
{
    //class DriverOpticsGroup
