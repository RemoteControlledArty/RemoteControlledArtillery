/*
    RC UI OnLoad (RscTitles)
*/

params ["_display"];

diag_log "[RC][UI] RC_Artillery onLoad fired";
systemChat "[RC] UI onLoad";

uiNamespace setVariable ["RC_Artillery", _display];

// init RC UI logic
[_display, getConnectedUAV player] call RC_fnc_RC_UI_Init;
