...
class RC_IC_IFV_A_Base: B_APC_Wheeled_01_cannon_F
{
	class Turrets;
	class MainTurret;
...
class RC_IC_IFV_A: RC_IC_IFV_A_Base
{
	author="Ascent";
...
class RC_Infantry_Carrier_A: RC_IC_IFV_A
{
