...
{
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_fetch.hpp"
};
class RC_MH80M_DAP_Base: RC_MH80M_DAP_Core
{
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_main.hpp"

	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_fixedPilotCam.hpp"
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_freePilotCam.hpp"
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_userActions.hpp"
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_hitPoints.hpp"
	...
	{
		//#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_components_sensors.hpp"
		//#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_components_panels.hpp"
		#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_components_4pylons.hpp"
	};
	class Turrets: Turrets
	{
		#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_copilotTurret.hpp"
		#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_cargoTurrets_frontRear.hpp"
	};
...
{
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_EHs_UV.hpp"
	#include "\Remote_Controlled_Artillery\cfgVehicles\includes_vehicle\MH80M_UV_conversion.hpp"

	displayName="OM MH-80M DAP"
};
class RC_OM_MH80M_DAP: RC_OM_MH80M_UV
{
	scope=1;			//2
	scopeCurator=0;		//2
	forceInGarage=0;	//1
