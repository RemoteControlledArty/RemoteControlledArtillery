...
class RC_OffroadUp_Interceptor_Fetch: I_G_Offroad_01_armor_AT_lxWS
{
	class ViewOptics;
	class Turrets;
	class AT_Turret;
...
class RC_OffroadUp_Interceptor_Base: RC_OffroadUp_Interceptor_Fetch
{
	...
	memoryPointDriverOptics="RoofLight_L_pos";	//RoofLight_L_pos,	RoofLight_L_dir, RoofLight_L_flare
...
class RC_OffroadUp_Interceptor_Direct_O: RC_OffroadUp_Interceptor_Direct
{
...
class RC_OffroadUp_Interceptor_Direct_I: RC_OffroadUp_Interceptor_Direct
{
...
/*
class RC_OffroadUp_Interceptor_Overfly: RC_OffroadUp_Interceptor_Direct
{
	displayname="OffroadUp AA-Interceptor (Overfly)";
...
class RC_OffroadUp_Interceptor_Overfly_O: RC_OffroadUp_Interceptor_Overfly
{
	faction="RemoteControlled_O";
	//crew="I_UAV_AI";
	side=0;
...
class RC_OffroadUp_Interceptor_Overfly_I: RC_OffroadUp_Interceptor_Overfly
{
	faction="RemoteControlled_I";
	//crew="I_UAV_AI";
	side=2;
...
class RC_OffroadUp_Interceptor_TopDown_O: RC_OffroadUp_Interceptor_TopDown
{
	faction="RemoteControlled_O";
	//crew="I_UAV_AI";
	side=0;
...
class RC_OffroadUp_Interceptor_TopDown_I: RC_OffroadUp_Interceptor_TopDown
{
	faction="RemoteControlled_I";
	//crew="I_UAV_AI";
	side=2;
...
class RC_OffroadUp_Interceptor_Cruise_O: RC_OffroadUp_Interceptor_Cruise
{
	faction="RemoteControlled_O";
	//crew="I_UAV_AI";
	side=0;
...
class RC_OffroadUp_Interceptor_Cruise_I: RC_OffroadUp_Interceptor_Cruise
{
	faction="RemoteControlled_I";
	//crew="I_UAV_AI";
	side=2;
