...
{
	case "RC_ULM_1Rnd_60mm_Mo_shells": {_HECount = _HECount + 1};
	case "RC_ULM_1Rnd_60mm_Mo_HEAB": {_HEABCount = _HEABCount + 1};
	case "RC_ULM_1Rnd_60mm_Mo_backupHEAB": {_HEABbackupCount = _HEABbackupCount + 1};
	case "RC_ULM_1Rnd_60mm_Mo_Smoke": {_smokeCount = _smokeCount + 1};
...
for "_i" from 1 to _HECount do {_mortar addMagazineTurret ["RC_ULM_1Rnd_60mm_Mo_shells", [0]];};
for "_i" from 1 to _HEABCount do {_mortar addMagazineTurret ["RC_ULM_1Rnd_60mm_Mo_HEAB", [0]];};
for "_i" from 1 to _HEABbackupCount do {_mortar addMagazineTurret ["RC_ULM_1Rnd_60mm_Mo_backupHEAB", [0]];};
for "_i" from 1 to _smokeCount do {_mortar addMagazineTurret ["RC_ULM_1Rnd_60mm_Mo_Smoke", [0]];};
