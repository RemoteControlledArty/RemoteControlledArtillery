class RC_FSV_Core;
class RC_AI_B_Rooikat_Fetch: RC_FSV_Core
{
	class Turrets;
	class MainTurret;
...
class RC_AI_B_Rooikat_Core: RC_AI_B_Rooikat_Fetch
{
...
class RC_AI_B_Rooikat_Base: RC_AI_B_Rooikat_Core
{
...
class RC_AI_B_Rooikat_A: RC_AI_B_Rooikat_Base
{
	scope=2;
	scopeCurator=2;
