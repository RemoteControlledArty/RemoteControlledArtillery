class RC_AbramsX_Core;
class RC_AI_B_AbramsX_Fetch: RC_AbramsX_Core
{
	class Turrets;
	class MainTurret;
...
class RC_AI_B_AbramsX_Core: RC_AI_B_AbramsX_Fetch
{
...
class RC_AI_B_AbramsX_Base: RC_AI_B_AbramsX_Core
{
...
class RC_AI_B_AbramsX_WD: RC_AI_B_AbramsX_Base
{
	scope=2;
	scopeCurator=2;
