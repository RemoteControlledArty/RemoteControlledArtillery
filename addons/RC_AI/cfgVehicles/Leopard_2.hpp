class RC_MBT_2_Core;
class RC_AI_B_Leopard_Fetch: RC_MBT_2_Core
{
	class Turrets;
	class MainTurret;
	class AdvisorOptics;
...
class RC_AI_B_Leopard_Core: RC_AI_B_Leopard_Fetch
{
...
class RC_AI_B_Leopard_Base: RC_AI_B_Leopard_Core
{
...
class RC_AI_B_Leopard_A: RC_AI_B_Leopard_Base
{
	scope=2;
	scopeCurator=2;
