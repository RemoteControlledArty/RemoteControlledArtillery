class RC_IFV_5_WD2;	//Arid is WS, Woodland is Aegis!
class RC_AI_B_BM2T_WD_Core: RC_IFV_5_WD2
{
	class Turrets;
	class MainTurret;
...
class RC_AI_B_BM2T_WD_Base: RC_AI_B_BM2T_WD_Core
{
	/*
...
class RC_AI_B_BM2T_WD: RC_AI_B_BM2T_WD_Base
{
	scope=2;
	scopeCurator=2;
