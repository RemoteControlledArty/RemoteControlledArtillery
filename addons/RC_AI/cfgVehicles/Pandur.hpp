//class RC_IFV_3_A;
class RC_IFV_3_Core;
class RC_AI_B_Pandur_Fetch: RC_IFV_3_Core
{
	class Turrets;
	class MainTurret;
...
class RC_AI_B_Pandur_Core: RC_AI_B_Pandur_Fetch
{
...
class RC_AI_B_Pandur_Base: RC_AI_B_Pandur_Core
{
...
class RC_AI_B_Pandur_A: RC_AI_B_Pandur_Base
{
	scope=2;
	scopeCurator=2;
