class RC_M1A2_SEPV2_Core;
class RC_AI_B_M1A2_SEPV2_Fetch: RC_M1A2_SEPV2_Core
{
	class Turrets;
	class MainTurret;
	class CROWS_Turret;
...
class RC_AI_B_M1A2_SEPV2_Core: RC_AI_B_M1A2_SEPV2_Fetch
{
...
class RC_AI_B_M1A2_SEPV2_Base: RC_AI_B_M1A2_SEPV2_Core
{
...
class RC_AI_B_M1A2_SEPV2_D: RC_AI_B_M1A2_SEPV2_Base
{
	scope=2;
	scopeCurator=2;
