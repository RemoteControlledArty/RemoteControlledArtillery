switch (true) do {
	...
	case((_realElevation < (_lowAngleSol + 0.5)) and (_realElevation > (_lowAngleSol - 0.5))): {_ctrlElevation ctrlSetTextColor [0,1,0,1];};
	case((_realElevation < (_highAngleSol + 0.5)) and (_realElevation > (_highAngleSol - 0.5))): {_ctrlElevation ctrlSetTextColor [0,1,0,1];};

	case((_realElevation < (_lowAngleSol + 0.75)) and (_realElevation > (_lowAngleSol - 0.75))): {_ctrlElevation ctrlSetTextColor [0.725,1,0.5,1];};
	case((_realElevation < (_highAngleSol + 0.75)) and (_realElevation > (_highAngleSol - 0.75))): {_ctrlElevation ctrlSetTextColor [0.725,1,0.5,1];};
