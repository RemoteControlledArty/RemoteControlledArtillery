...
class RC_Crocus_Carrier_PvP_A_I: RC_Crocus_Carrier_PvP_A
{
	faction="RemoteControlled_I";
	crew="I_UAV_AI";
	side=2;
...
class RC_Crocus_Carrier_PvP_WD: RC_Crocus_Carrier_PvP_A
{
	editorPreview="\A3\EditorPreviews_F_Exp\Data\CfgVehicles\B_T_UGV_01_olive_F.jpg";
	textureList[]=
	{
...
class RC_Crocus_Carrier_PvP_WD_O: RC_Crocus_Carrier_PvP_WD
{
	faction="RemoteControlled_O";
	crew="O_UAV_AI";
	side=0;
...
class RC_Crocus_Carrier_PvP_WD_I: RC_Crocus_Carrier_PvP_WD
{
	faction="RemoteControlled_I";
	crew="I_UAV_AI";
	side=2;
