...
class RC_AMV_SHORAD_manned_B: RC_AMV_SHORAD_Base
{
	class EventHandlers: EventHandlers
	{	
		class RC_Artillery
...
class RC_AMV_SHORAD_manned_O: RC_AMV_SHORAD_Base
{
	scope=2;
	scopeCurator=2;
	//forceInGarage=1;
...
class RC_AMV_SHORAD_manned_I: RC_AMV_SHORAD_Base
{
	scope=2;
	scopeCurator=2;
	//forceInGarage=1;
