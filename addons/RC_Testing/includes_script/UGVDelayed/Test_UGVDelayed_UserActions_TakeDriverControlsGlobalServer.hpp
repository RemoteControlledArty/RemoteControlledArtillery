class UserActions: UserActions
{
	class DriveControlsCommander
	{
		...
		statement="[this, RC_fnc_RC_Test_UGVDelayed_TakeControlCommanderServer] remoteExec ['call', 2]";
	};
	class DriveControlsGunner
	{
		...
		statement="[this, RC_fnc_RC_Test_UGVDelayed_TakeControlGunnerServer] remoteExec ['call', 2]";
	};
};